...
def test_create_case_saves_record(test_db):
    ...
    case = case_service.create_case(test_db, "Johnson Refinance 2024", broker_id)
...
def test_get_missing_case_raises(test_db):
    ...
    with pytest.raises(CaseNotFound):
        case_service.get_case_with_documents(test_db, case_id)
...
def test_delete_missing_case_raises(test_db):
    ...
    with pytest.raises(CaseNotFound):
        case_service.delete_case(test_db, case_id)
