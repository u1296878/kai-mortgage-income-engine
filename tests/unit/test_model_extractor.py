...
def test_model_extractor_returns_fields_with_source_refs():
    ...
    backend = FakeBackend(
        {
            "fields": {
                "tax_year": {"value": 2023, "confidence": 0.97, "source_text": "2023", "source_line_ids": ["L0001"]},
    ...
    assert by_name["schedule_c_net_profit"].raw_text == "31 Net profit or loss Line 31 94,380"
