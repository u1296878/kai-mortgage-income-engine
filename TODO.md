...
- [ ] Responsive processing, Step 2: parallelize OCR per page with bounded worker count, `OMP_THREAD_LIMIT=1`, configured DPI/page settings, and named per-page timeout errors
