...
Income engine, Phase 12 (Schedule C extraction defects) is complete:
- Schedule C line 13 depreciation now uses the line-number row to capture far-right values even when labels wrap.
